                ...
                {customers.map((customer) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      />
                      <div>
                        <p className={`text-sm font-medium ${selectedCustomer?.id === customer.id ? "text-[#6237A0]" : "text-gray-800"}`}>
                          {customer.name}
                        </p>
                        <p className={`text-xs ${selectedCustomer?.id === customer.id ? "text-[#6237A0]" : "text-gray-500"}`}>
                          {customer.number}
                        </p>
                      </div>
                    </div>
                ...
                <div className="flex flex-col h-full justify-between">
                  ...
                  <div className="border-b pb-2 text-[#CECECE]">
                    <div className="flex items-center gap-4">
                      ...
                      <button className="p-2 text-black hover:text-[#6237A0] transition rounded-full"
                      onClick={() => toggleDropdown('customerMenu')}>
                        <MoreVertical size={22} />
                      </button>
                      {/* Dropdown menu */}
      {openDropdown === 'customerMenu' && (
        <div  ref={dropdownRef} className="absolute right-0 mt-2 w-44 bg-white border border-gray-300 rounded-md shadow-sm z-20">
          <button
          ...
          >
            Transfer Department
                  ...
                  {/* Chat messages */}
                  <div className="flex-1 flex flex-col gap-4 overflow-y-auto overflow-x-hidden px-4 pb-2 auto-hide-scrollbar">
                  ...
                  <div className="mt-4 flex items-center gap-2 border-t pt-4 text-[#CECECE]">
                    ...
                    />
                    <button className="p-2 text-[#5C2E90]" onClick={sendMessage}>
                      <Send size={20} />
                    </button>
                  </div>
                </div>
